      ...
      <div className="container mx-auto px-6 text-center">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 max-w-4xl mx-auto">
          {skills.map((skill, index) => (
            <div 
              key={index} 
              className="flex flex-col items-center justify-center p-6 bg-[#111] rounded-xl border border-gray-800 hover:border-pink-500 hover:bg-[#1a1a1a] transition-all duration-300 transform hover:-translate-y-2"
            >
              {/* Icon Container */}
